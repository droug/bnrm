...
DROP POLICY IF EXISTS "Admins et bibliothécaires peuvent uploader des médias" ON storage.objects;
DROP POLICY IF EXISTS "Admins et bibliothécaires peuvent mettre à jour des médias" ON storage.objects;
DROP POLICY IF EXISTS "Admins et bibliothécaires peuvent supprimer des médias" ON storage.objects;
DROP POLICY IF EXISTS "Tout le monde peut voir les médias" ON storage.objects;
