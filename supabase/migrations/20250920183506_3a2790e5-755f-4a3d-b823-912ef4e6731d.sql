...
('Traité de médecine', 'Ibn Sina', 'Manuel médical complet', 'Arabe', 'XIe siècle', 'Papier', 'restricted', 'maintenance', 'MS-004'),
('Livre des Étoiles', 'Al-Battani', 'Traité d''astronomie avec cartes célestes', 'Arabe', 'Xe siècle', 'Vélin', 'public', 'available', 'MS-005'),
('Diwan de poésie', 'Ibn Hazm', 'Recueil de poèmes d''amour courtois', 'Arabe', 'XIe siècle', 'Papier', 'public', 'reserved', 'MS-006'),
('Atlas céleste', 'Al-Sufi', 'Cartes des constellations', 'Arabe', 'Xe siècle', 'Parchemin', 'restricted', 'digitization', 'MS-007');
