-- Créer la fonction pour obtenir les permissions selon le profil
...
-- Mettre à jour les profils existants pour démontrer les nouveaux rôles
UPDATE profiles SET role = 'partner', partner_organization = 'Institut du Maroc' 
WHERE first_name = 'Ahmed' AND last_name = 'Benali';