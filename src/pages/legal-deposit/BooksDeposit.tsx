...
export default function BooksDeposit() {
  ...
  const documents = [
    "Livres imprimés (fiction, essais, manuels, etc.)",
    "E-books",
    "Thèses et mémoires",
    "Ouvrages scolaires et universitaires",
    "Beaux-livres et expositions"
  ];
      ...
      <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
        ...
        <main className="container mx-auto px-4 py-8">
          <div className="max-w-4xl mx-auto space-y-6">
            <LegalDepositHeader
              title="Dépôt Légal - Livres"
              subtitle="Formulaire de déclaration pour les livres et publications imprimées"
              icon={Book}
