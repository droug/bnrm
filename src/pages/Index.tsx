    ...
    <>
      ...
      {showDigitalServices && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm" onClick={() => setShowDigitalServices(false)}>
          <Card className="relative w-full max-w-4xl mx-4 overflow-hidden border-3 border-gold/25 shadow-2xl" onClick={(e) => e.stopPropagation()}>
            <div className="absolute inset-0 bg-pattern-filigrane opacity-10"></div>
            <div className="absolute inset-0 bg-gradient-mosaique opacity-95"></div>
            <CardContent className="p-8 relative z-10">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h2 className="text-3xl font-moroccan font-bold text-foreground mb-2">Services Numériques</h2>
                  <div className="w-32 h-2 bg-gradient-neutral rounded-full shadow-gold"></div>
                </div>
                <Button variant="ghost" size="icon" onClick={() => setShowDigitalServices(false)} className="rounded-full">
                  <X className="h-6 w-6" />
                </Button>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[
                  { 
                    ...
                    subtitle: "Recherche dans le catalogue", 
                    icon: Search, 
                    color: "text-primary", 
                    bg: "bg-primary/10", 
