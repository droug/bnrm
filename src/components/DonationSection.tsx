  ...
  return (
    <div className="relative py-20 my-12 overflow-hidden rounded-lg">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <Card className="relative overflow-hidden border-2 border-orange-200/30 shadow-2xl bg-gradient-to-br from-orange-900/20 via-blue-900/20 to-blue-900/30 backdrop-blur-sm">
          {/* Decorative background elements */}
          <div className="absolute top-0 right-0 w-64 h-64 bg-orange-500/10 rounded-full blur-3xl opacity-50 -mr-32 -mt-32" />
          <div className="absolute bottom-0 left-0 w-64 h-64 bg-blue-500/10 rounded-full blur-3xl opacity-50 -ml-32 -mb-32" />
