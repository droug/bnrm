...
interface PrinterInlineFormProps {
  initialName: string;
  onPrinterAdded: (printer: Printer) => void;
  onCancel: () => void;
}

export const PrinterInlineForm = ({
  initialName,
  onPrinterAdded,
  onCancel,
}: PrinterInlineFormProps) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (insertError) {
        console.error("Error inserting printer:", insertError);
      ...
      onPrinterAdded(printer as Printer);
    } catch (error) {
  ...
  return (
    <div className="p-4 space-y-4 border-t bg-muted/30">
      <div className="flex items-center gap-2 text-sm font-medium text-primary">
        ...
        <span>Ajouter une nouvelle imprimerie</span>
      </div>
      ...
      <div className="space-y-3">
        ...
        <div className="space-y-1">
          <Label className="text-xs">
            Nom de l'imprimerie <span className="text-destructive">*</span>
          </Label>
          <Input
        ...
        <div className="space-y-1">
          ...
          <div className="relative">
            ...
            <Input
              type="email"
              placeholder="email@imprimerie.ma"
