...
import kitabBackground from "@/assets/kitab-calligraphy.jpg";
                  ...
                  >
                    ...
                    <div className={`absolute inset-0 bg-gradient-to-b ${bookColors[index]} rounded-sm shadow-lg`}>
                      ...
                      <img 
                        src={platform.image}
                        alt={platform.title}
                        className={`absolute inset-0 w-full h-full object-cover mix-blend-overlay ${index === 1 ? 'opacity-40' : 'opacity-10'}`}
                      />
