  ...
  return (
    <CustomDialog open={isOpen} onOpenChange={handleClose} modal={false}>
      <CustomDialogContent
        ...
        position="fixed"
        centered={false}
        className="!fixed !top-4 !left-1/2 !-translate-x-1/2 !right-auto !bottom-auto max-w-4xl max-h-[90vh] overflow-y-auto p-0 border-3 border-gold/30 shadow-mosaique bg-background backdrop-blur-none"
      >
